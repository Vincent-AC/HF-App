...
mod_input_drug_charac_1comp_abs_ui <- function(id) {
  ns <- NS(id)
  tagList(
    shinydashboard::box(
      ...
      numericInput(
        ns("ka"),
        "First order absorption rate constant - ka (hours)",
        1,
        min = 0,
        step = 0.1
      ),
...
#'}
#' @noRd
mod_input_drug_charac_1comp_abs_server <- function(id,
                                         minPumpFlow,
                                         maxPumpFlow,
                                         stepPumpFlow,
                                         Vcentral,
...
# mod_input_drug_charac_1comp_abs_ui("input_drug_charac_1")

## To be copied in the server
# mod_input_drug_charac_1comp_abs_server("input_drug_charac_1")
