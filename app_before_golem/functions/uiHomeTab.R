home <-  fluidPage(fluidRow(
  ...
  box(
    ...
    tags$a(
      href = "mailto:vincent@aracli.org",
      title = "email",
      target = "_blank",
      rel = "noopener noreferrer",
      icon("envelope")
    ...
    tags$a(
      href = "https://twitter.com/ClimentVincent",
      title = "twitter",
      target = "_blank",
      rel = "noopener noreferrer",
      icon("twitter-square")
    ...
    br(),    br(),
    "Alexia Chauzy, Nicolas Grégoire",
    br(),    br(),
...
fluidRow(
  box(    title = "Quick-start guide",
          ...
          width = 12,
          tags$a(
            href = "instructions_html.html",
            title = "popout_instructions",
            onclick="window.open('instructions_html.html','newwindow','width=300,height=250');return false;",
            rel = "noopener noreferrer",
